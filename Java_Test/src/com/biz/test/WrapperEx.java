...
public class WrapperEx {
	...
	public static void main(String[] args) {
		/*
		 * Primitive
		 * Java언어에 공식적으로 내장된 변수 선언문
		 * 어떤 값을 메로리에 저장하는 용도로 변수를 선언하는 명령문
		 ...
		 * 일반적인 클래스는 이러한 문법을 절때 사용할수 없다.
		 * wrapper 클래스는 primitive 데이터와 서로 주고받는 관계가 성립된다.
		 * int형 값20을 Integer형 num2 객체에 할당을 하면
		 * 내부적으로 자동으로 int형을 Integer형으로 Boxing한다.
		 * 
		 * 
		 */
		Integer num2 = 20; // int형 20 을 INT
		/*
