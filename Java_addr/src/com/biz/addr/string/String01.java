...
public class String01 {
	...
	public static void main(String[] args) {
		 ...
		 *  
		 *  문자열을 == 비교연산자로 비교를 하면
		 *  원칙은 주소로 비교를 하나, 어떤때느 문자열 값으로 비교하기도 하고
		 *  어떤때는 주소로 비교한다.
		 *  
		 *  똑같은 문자열 임에도 불구하고 결과는 true, false 예측하기 어렵다
		 *  
		 * ※!!!경고!!! 따라서 문자열은 절대( == 비교 연산자)로 비교하면 안된다.
		 *  JAVA 에서는 !!!
		 */
		String str1 = "Korea";
		String str2 = "Korea";
		...
		/*
		 * 문자열형 변수
		 * 기본형 변수와 같은 방식으로 사용을 하지만 태생은 class이다.
		 * 즉 문자열형 변수 String 클래스의 객체(인스턴스)이다.
		 * 객체 : .을 찍고 뒤에 method를 쓸수 있도록 만든 것이다.
		 * 따라서 String 클래스에 정의된 다양한 method들을 사용할수 있다는 것이다.
		 * 그중 가장 많이 사용하는 method가 바로 문자열변수의 값을 비교하는 equels() method이다.
		 * 
		 * equals()
		...
		System.out.println("Korea".equals("KOREA")); //false  주로 PW 비교
		System.out.println("Korea".equalsIgnoreCase("KOREA")); //true  주로 ID 비교
