...
/*
 * 아무런 코드도 없는 클래스르 하나 생성하면
 * 클래스 내부에는 기본 생성자 라고 하는 특별한 method가 자동으로 선언이 된다.
 */
public class NewClass_01 {
	 ...
	 *  
	 *  생성자를 임의로 재작성하는 이유
	 *  1. 클래스에 선언된 필드변수들을 초기화 하기 위하여 (주목적)
	 *  2. 클래스를 객체로 선언하고 초기화 할때 자동으로 실행될 어떤 일들이 필요 할때 (부수적인것)
	 *  
	 *  클래스를 선언만 하고
