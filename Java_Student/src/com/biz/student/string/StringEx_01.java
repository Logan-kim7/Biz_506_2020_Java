...
public class StringEx_01 {
	public static void main(String[] args) {
		...
		/*
		 * StrNation은 문자열 변수이면서 String 클래스를 사용하여 마든
		 * String type 객체이다.
		 * 따라서 (.) 연산자를 통하여 다양한 method를 사용할수 있다.
		 *  
		 */
		...
		System.out.println(strNation.toLowerCase());  // 모두 소문자로바꿔주기
		
		// strNation에 담긴(전체) 문자열이 korea 냐? 하고 물어보는 것
		...
		// strNation 문자열중(부분) "Korea"라는 문자열이 들어있냐??
		strNation = "Repulic of Korea";
		...
		//문자열을 객체변수에 담지 않고 바로 대문자로 바꾸고 싶을경우 사용하는 방법
