 ...
 * 필드변수와 method는 public, protected로 되어있는 경우에만 상속된다.
 */
public class StudentServiceImplV2 extends StudentServiceImplV1 {
	...
	public StudentServiceImplV2() {
		String StudentFile = "src/com/biz/student/exec/student_List.txt";
				// exception Handling(예외 처리시스템)
				// 파일을 작성하는 과정에서
				// 아무리 코드를 잘작성해도 운영체제 차원에서 발생하는 exception은
				...
				try {
					...
					//e.printStackTrace();
					System.out.println(StudentFile + "파일을 찾을수 없음!!");
					return;
		}
	}
	...
	// List결과를 file에 저장하여 프로젝트가 종료 되어도 언제든지
	// 결과를 확인할수 있도록 구현해보자
