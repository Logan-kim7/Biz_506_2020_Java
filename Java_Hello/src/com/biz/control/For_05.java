	...
	public static void main(String[] args) {
		...
		for(; num < 10 ;) {
			...
			for(num = 0, sum = 0; num < 10 ;) {
				 ...
				 * for(초기화명령; 조건문; 증감문)
				 * 
				 * 1. for(1;조건문;2) 명령을 만나면
				 * 2. 1 초기화명령을 무조건 실행한다.(단, 한번만)
				 * 3. 조건문을 실행하여 결과가 true이면 {} 안의 명령문을 실행
				 * 4. {} 명령문을 실행한 후 for(;조건문;2)명령문으로 이동하여
				 * 5. 2증감(num++)명령문을 실행한다.
				 * 6. 다시 (조건문)을 실행하여 결과가 true인지 검사한다.
				 *    그리고 계속하여 반복하거나, 중단한다.
				 */
