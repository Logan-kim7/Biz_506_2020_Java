...
public class VarBoolean_04 {
	...
	public static void main(String[] args) {
		...
		/*
		 *  변수의 초기화
		 *  type 생성 키워드로 선언만 변수는 사용하는데 제약이 있다.
		 ...
		 *  
		 *  변수를 선언한 후 어떠한 값을 저장하는 것을
		 *  변수를 초기화 한다 라고 한다.
		 *  변수는 초기화가 되어야만 사용(읽기, 쓰기)가 가능하다.
		 *  변수는 기본적으로 제공되는 
		 *  int, float, long, double, boolean, char....등등 들은
		 ...
		 * 기본적으로 제공되지 않는 필요에 따라 JDK를 inport 해서
		 * 선언하는 변수들은 초기화 하는 방법이 조금 다르다
		 * 
		 * 키워드 변수 = new 키워드()
		 * 이것은 java의 문법 구조이므로 형식 그대로 이해하자
		 */
		Random rnd = new Random();
		
		int num1 = 0;
		/*
		 * 기본으로 제공되는 변수 키워드로 작성된 변수는 
		 ...
		 * 
		 * .nextint(100) nethod를 연결하면 
		 * 이 명령문은 0부터 99까지의 임의 정수를 만들어
		 * num1변수에 저장한다.
		 * 
		 */
		num1 = rnd.nextInt(20); // () 안의 숫자 0 부터 -1 까지
