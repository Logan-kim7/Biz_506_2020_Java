...
public class Grade_02 {
	...
	public static void main(String[] args) {
		...
		//점,Dot(.) 연산자를 사용하여 또다른 기능의 명령어를 연결하고
		// 명령문을 이룰수 있다.
		// 아래의 명령문은 아무일도 수행하지 않는 것처럼 보이지만
		// 실제로는 무언가 기능을 수행하게 된다.
		// 이 명령문은 Console에 표시하는 기능이 없기때문에 
		// 수행된 결과를 확인할 수 없을 뿐이다.
		
		
		// 점 연산자를 사용하여 연결되는 명령문 중 () 가 부착되는 명령문을
		//   method라고 부른다.
		...
		// 아래의 코드는 일단 nextInt() method를 실행한 후
		// 결과를 num이라는 변수에 보관을 한다.
		int num = rnd.nextInt();
		
		
		System.out.println(num);
		
		// nextInt()는 사칙연산자와 혼합하여 연산을 수행할수 있는데
